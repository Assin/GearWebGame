package kernel.display.components
{
	...
	public class SWFProfiler
	{
		...
		private static var logTF:TextField = null;
		
		public static function init(swf:Stage, context:InteractiveObject, contentItems:Array, width:Number, height:Number):void
		{
			...
			logTF = new TextField();
			logTF.y = 120;
			logTF.textColor = 0x000000;
			logTF.background = true;
			logTF.backgroundColor = 0xffffff;
			logTF.width = width;
			logTF.height = height - 120;
