package kernel.utils
{
	...
	/**
	 * @name 封装很多与External操作有关的方法
	 * @explain
	 * @author opensource
	 * @create 2011 Nov 3, 2011 2:20:54 PM
	 */
	public class ExternalUtil
	{
		...
		public static function BrowserMatch():Object
		{
			...
			var match:Object = regWebkit.exec(ua) || ropera.exec(ua) || rmsie.exec(ua) || ua.indexOf("compatible") < 0 &&
				rmozilla.exec(ua) || [];
		 ...
		 *
		 */
		public static function call(funName:String, ... args):*
		{
			var arr:Array = args;
			if (arr == null)
			{
			...
			arr.unshift(funName);
			return ExternalInterface.call.apply(null, arr);
		}
		...
		{
			NavigateToURL("javascript:window.location.reload( false );");
		}
		 ...
		 * 
		 */		
		public static function setCookie(key:String, value:String, validDays:int = 30):void
		{
			call("setCookie",key, value, validDays);
		}
		/**
		 * 获得cookie，如果没有则返回"" 
		 * @param key
